...
class FlipCountsTest(parameterized.TestCase):
  ...
  def test_flip_counts(
      self, base_prediction, model_prediction, expected_flip_count
  ):
    self.assertEqual(
  ...
  def test_flip_counts_batched(self):
    ...
    testing.assert_array_equal(
        flip_counts.flip_counts(base_predictions, model_predictions),
